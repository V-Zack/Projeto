...
@WebServlet(name = "ServletQuadro", urlPatterns = "/servletQuadro")
public class ServletQuadro extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws ServerException, IOException {
        ...
        System.out.println(" Descrição do Serviço: "+ descricao + " Status: " + status + " Local: "+ local + " Responsável: "+ responsavel +" Data Início: " + dtInicio + "Data Fim" + dtFim );
